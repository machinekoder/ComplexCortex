...
typedef enum {
    Iap_Status_CommandSuccess = 0u,
    Iap_Status_InvalidCommand = 1u,
    Iap_Status_SourceAddressError = 2u,
    Iap_Status_DestinationAddressError = 3u,
    Iap_Status_SourceAddressNotMapped = 4u,
    Iap_Status_DestinationAddressNotMapped = 5u,
    Iap_Status_CountError = 6u,
    Iap_Status_InvalidSector = 7u,
    Iap_Status_SectorNotBlank = 8u,
    Iap_Status_SectorNotPreparedForWriteOperation = 9u,
    Iap_Status_CompareError = 10u,
    Iap_Status_Busy = 11u
} Iap_Status;
