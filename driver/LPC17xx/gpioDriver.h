...
#define GPIO4_CLEAR_DIR(pin)            LPC_GPIO4->FIODIR &= ~(1 << pin)
#define GPIO4_SET_DIR(direction,pin)    LPC_GPIO4->FIODIR |= (direction << pin)
...
#define GPIO4_READ(pin)                 ((LPC_GPIO4->FIOPIN & (1 << pin)) > 0)
...
#define GPIO4_SET(pin)                  LPC_GPIO4->FIOSET |= (1 << pin)
