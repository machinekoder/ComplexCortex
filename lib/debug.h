...
#define TWBUFF_SIZE 0x100u
#define TRBUFF_SIZE 0x100u

/* target and client pointers at the end of the buffers */
#define TWBUFF_TPTR (g_TWBuffer[TWBUFF_SIZE+0u])
#define TWBUFF_CPTR (g_TWBuffer[TWBUFF_SIZE+1u])
#define TRBUFF_TPTR (g_TRBuffer[TRBUFF_SIZE+0u])
#define TRBUFF_CPTR (g_TRBuffer[TRBUFF_SIZE+1u])
/* number of pointers */
#define TBUFF_PTR 2
/* buffer lenghth */
...
/* max buffer size */
#define TWBUFF_MAX (TWBUFF_SIZE-1u)
#define TRBUFF_MAX (TRBUFF_SIZE-1u)

/* buffer manipulation helpers */
#define TWBUFF_EMPTY() (TWBUFF_TPTR==TWBUFF_CPTR)
#define TWBUFF_FULL() (TWBUFF_TPTR==((TWBUFF_CPTR-1)&(TWBUFF_SIZE-1u)))
#define TWBUFF_INC(n) (++n&(TWBUFF_SIZE-1u))
